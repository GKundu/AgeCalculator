...
public class Age_Calculator {
	...
	//Finally, display the user's age in this year, but only if it's valid.
        if (anotherYear < currentYear && newAge >= 0 && newAge != 1) {
            ...
            System.out.println("You will be " + newAge + "-year-old in " + anotherYear + ".");
            ...
            System.out.println("Wait a second, you were not born in that year...yet");
